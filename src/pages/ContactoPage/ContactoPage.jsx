...
export const ContactoPage = () => {
	...
	const mapa = "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d16257412.644924697!2d-85.00739660334729!3d5.842249700511246!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8e15a43aae1594a3%3A0x9a0d9a04eff2a340!2sColombia!5e0!3m2!1ses!2sco!4v1761260435090!5m2!1ses!2sco" //mapa del local
			...
			<div className="grid grid-flow-col grid-rows-2 place-items-center gap-y-5">
				...
				<section className="mx-auto max-w-lg h-auto">
					...
					<form action={`https://formsubmit.co/${correo}`} 
						...
						method="POST"
					>
						<input type="text" name="nombre" className="formInput" placeholder="Nombre completo" required />
						<input type="email" name="email" className="formInput" placeholder="Correo electronico" required />
