export const MascotasListado = ({data}) => {
	...
	return (
			<div className="flex flex-col justify-center items-center gap-3 p-5 w-full h-auto lg:p-5 sticky left-0">
				<div className="w-50 h-50 lg:w-65 lg:h-65 marco-mascotas">
					<img src={data.image} alt={`Mascota ${data.nombre}`} max-width="260" max-height="260" loading="lazy" />
				</div>
